                ...
                <form action="{{ route('admin.transaction-charge-store') }}" method="POST" >
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 mb-3">
                            ...
                            <input type="text" name="tuition_charge_amount" class="form-control @error('tuition_charge_amount') is-invalid @enderror" id="basic-default-fullname" placeholder="" />
                        ...
                        <div class="col-12 col-lg-6 mb-3">
                            ...
                            <input type="text"   name="visa_charge_amount" class="form-control  @error('visa_charge_amount') is-invalid @enderror" id="basic-default-company" placeholder="" />
                        ...
                        <div class="col-12 col-lg-6 mb-3">
                            ...
                            <input type="text"   name="corporate_charge_amount" class="form-control  @error('corporate_charge_amount') is-invalid @enderror" id="basic-default-company" placeholder="" />
                        ...
                        <div class="col-12 col-lg-6 mb-3">
                            ...
                            <input type="text"   name="merchant_charge_amount" class="form-control  @error('merchant_charge_amount') is-invalid @enderror" id="basic-default-company" placeholder="" />
                        ...
                        <div class="col-12 col-lg-6 mb-3">
                            ...
                            <input type="text"   name="flights_charge_amount" class="form-control  @error('flights_charge_amount') is-invalid @enderror" id="basic-default-company" placeholder="" />
                            @error('flights_charge_amount')
                            <span class="invalid-feedback" role="alert">{{  $message  }}</span>
                            @enderror
                        </div>
                        <div class="col-12 col-lg-6 mb-3">
                            <label class="form-label" for="basic-default-company">{{  __('OtherService Charge Amount') }}</label>
                            <input type="text"   name="other_service" class="form-control  @error('other_service') is-invalid @enderror" id="basic-default-company" placeholder="" />
                            @error('other_service')
                            <span class="invalid-feedback" role="alert">{{  $message  }}</span>
                            @enderror
                        </div>
