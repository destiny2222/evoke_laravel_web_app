        ...
        <div class="container-item shadow-lg p-r-3 p-l-3 p-b-3 p-t-3">
            <form action="{{  route('corporate-payment') }}" method="post">
                ...
                <div id='form'>
                    ...
                    <input type="text" name="amount" value="{{  number_format( $Corporate->amount, 2) }}" hidden  id="">
                    <input type="text" name="total" class="total-amount" id="" hidden value="{{  number_format(  $totalprecentages, 2)  }}">  
                    <div class="slide-two">
