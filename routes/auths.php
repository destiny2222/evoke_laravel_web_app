...
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth', 'verified', 'checkkyc']], function(){
    ...
    //
    Route::post('/flight/store', [FlightController::class, 'flightBooking'])->name('flightstore-page');
    Route::get('/flight/payment', [FlightController::class, 'flightsPayment'])->name('flightpayment-page');
